...
for seed in seeds:
    ...
    dr = 0.005 # choosen to reach min in around 400-500 episodes
    decay_rates = [i * dr for i in tunes]
    for tune, decay_rate in enumerate(decay_rates):
        ...
        suffix = str(seed) + "dr" + str(tunes[tune])
