...
for seed in seeds:
    ...
    ms = 72        # minimum memories needed for training
    tunes = [1.05,1.10,1.15]
    memory_sizes = [int(i * ms) for i in tunes]
    for tune, memory_size in enumerate(memory_sizes):
        ...
        suffix = str(seed) + "ms" + str(tunes[tune])
